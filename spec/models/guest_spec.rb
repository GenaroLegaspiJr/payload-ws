...
RSpec.describe Guest, type: :model do
  context 'validation tests' do
    it 'ensures presence of email' do
      guest = Guest.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, phone: Faker::PhoneNumber.cell_phone_in_e164)
      expect(guest.errors.full_messages.to_sentence).to eq("Email can't be blank")
    end
